...
- **File dialog** → retire in S06 by wiring `tauri-plugin-dialog` for document upload and verifying file selection, upload, and list display in the running app (S05 delivered scheduling UI as planned; file dialog risk belongs to S06 which owns document upload)
...
- [x] **S01: Navigation Shell & Type System** `risk:high` `depends:[]`
...
- [x] **S02: Patient Module** `risk:medium` `depends:[S01]`
...
- [x] **S03: Clinical Encounter Workspace** `risk:high` `depends:[S02]`
...
- [x] **S04: Clinical Data Sidebar** `risk:medium` `depends:[S02]`
...
- [x] **S05: Scheduling & Flow Board** `risk:medium` `depends:[S02]`
...
- [x] **S06: Labs, Documents & Physical Exam** `risk:low` `depends:[S03,S04]`
...
- [x] **S07: Settings, Cleanup & End-to-End Verification** `risk:low` `depends:[S01,S02,S03,S04,S05,S06]`
