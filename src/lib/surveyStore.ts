...
const BUILT_IN_TEMPLATES: Omit<SurveyTemplate, "id" | "createdAt" | "createdBy">[] = [
  {
    ...
    builtIn: true,
    fields: [
      { id: "pf-1", label: "Current Pain Level", fieldType: "PainScale", required: true, order: 0 },
      ...
      { id: "pf-4", label: "Pain started after an injury?", fieldType: "YesNo", required: true, order: 3 },
      { id: "pf-5", label: "Date pain began", fieldType: "Date", required: false, order: 4 },
      { id: "pf-6", label: "Average Pain Level (past week)", fieldType: "PainScale", required: true, order: 5 },
  ...
  },
  {
    ...
    builtIn: true,
    fields: [
      { id: "mh-1", label: "Do you have any chronic conditions?", fieldType: "YesNo", required: true, order: 0 },
      { id: "mh-2", label: "List current medications", fieldType: "Text", required: false, order: 1 },
      { id: "mh-3", label: "Any previous surgeries?", fieldType: "YesNo", required: true, order: 2 },
      { id: "mh-4", label: "Describe previous surgeries", fieldType: "Text", required: false, order: 3 },
      { id: "mh-5", label: "Family history of heart disease?", fieldType: "YesNo", required: true, order: 4 },
      { id: "mh-6", label: "Family history of cancer?", fieldType: "YesNo", required: true, order: 5 },
  ...
  },
  {
    ...
    builtIn: true,
    fields: [
      { id: "hp-1", label: "I acknowledge receiving the HIPAA Notice of Privacy Practices", fieldType: "YesNo", required: true, order: 0 },
      { id: "hp-2", label: "Date of acknowledgment", fieldType: "Date", required: true, order: 1 },
      { id: "hp-3", label: "I consent to electronic communication", fieldType: "YesNo", required: true, order: 2 },
