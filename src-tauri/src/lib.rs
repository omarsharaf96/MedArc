...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::scheduling::get_calendar_settings,
            commands::scheduling::save_calendar_settings,
            ...
            commands::document_center::rename_document,
            ...
            commands::llm_integration::get_llm_settings,
            // Calendar Events
            commands::calendar_events::create_calendar_event,
            commands::calendar_events::list_calendar_events,
            commands::calendar_events::update_calendar_event,
            commands::calendar_events::delete_calendar_event,
            // AI Assistant
            commands::assistant::send_assistant_message,
            commands::assistant::list_conversations,
            commands::assistant::get_conversation,
            commands::assistant::delete_conversation,
            commands::assistant::execute_assistant_action,
            commands::assistant::clear_message_actions,
            // AI Documentation
            commands::ai_documentation::save_note_sample,
            commands::ai_documentation::list_note_samples,
            commands::ai_documentation::delete_note_sample,
            commands::ai_documentation::add_ai_exercise,
            commands::ai_documentation::list_ai_exercises,
            commands::ai_documentation::delete_ai_exercise,
            ...
            commands::pdf_export::generate_schedule_pdf,
            commands::pdf_export::get_schedule_print_settings,
            commands::pdf_export::save_schedule_print_settings,
            commands::pdf_export::open_file_in_default_app,
